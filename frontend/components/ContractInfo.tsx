...
export default function ContractInfo() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="mb-8 border-b-4 border-black pb-4 text-center sm:text-left">
        <h2 className="text-4xl font-black uppercase tracking-tight text-white bg-black inline-block px-4 py-1">
          SYSTEM SPECS
        </h2>
      </div>
